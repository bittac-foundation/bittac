...
contract TokenController {
    /// @notice Called when `_owner` sends ether to the bittac Token contract
...
//File: contracts/bittacToken.sol
pragma solidity ^0.4.18;
...
contract bittacToken is Controlled {
    ...
    bittacToken public parentToken;
    ...
    bittacTokenFactory public tokenFactory;

////////////////
// Constructor
////////////////

    /// @notice Constructor to create a bittacToken
    /// @param _tokenFactory The address of the bittacTokenFactory contract that
    ...
    function bittacToken(
        ...
        tokenFactory = bittacTokenFactory(_tokenFactory);
        name = _tokenName;                                 // Set the name
        decimals = _decimalUnits;                          // Set the decimals
        symbol = _tokenSymbol;                             // Set the symbol
        parentToken = bittacToken(_parentToken);
...
////////////////
    ...
    /// @return The address of the new bittacToken Contract
    function createCloneToken(
        ...
        bittacToken cloneToken = tokenFactory.createCloneToken(
            this,
            _snapshotBlock,
            _cloneTokenName,
            _cloneDecimalUnits,
...
//////////
    ...
    function claimTokens(address _token) public onlyController {
        ...
        bittacToken token = bittacToken(_token);
...
contract bittacTokenFactory {
    ...
    function createCloneToken(
        ...
        string _tokenSymbol,
        bool _transfersEnabled
    ) public returns (bittacToken) {
        bittacToken newToken = new bittacToken(
            this,
            _parentToken,
            _snapshotBlock,
            _tokenName,
...
/// @author Jordi Baylina
/// @dev This contract controls the issuance of tokens for the bittac Token
...
/// @dev This is designed to control the issuance of a bittac Token for a
...
contract Campaign is TokenController, Owned {
    ...
    bittacToken public tokenContract;   // The new token for this Campaign
...
/// @param _tokenAddress Address of the token contract this contract controls
    ...
    function Campaign(
        ...
        tokenContract = bittacToken(_tokenAddress);// The Deployed Token Contract
